...
<head data-darkreader-mode="dynamic" data-darkreader-scheme="dark">
  ...
  * {
  ...
  -->
      ...
      <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
          <!--[if lt IE 9]>
            ...
            <![endif]-->
  <meta name="darkreader" content="61265d148fbb4445a0faf9434ae77823"><style class="darkreader darkreader--override" media="screen">.vimvixen-hint {
  ...
  <script>  $('#exampleModalCenter').modal({
  keyboard: false})
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <ul class="navbar-nav ms-auto">
                          ...
                          <li class="nav-item">
                            ...
                            <button type="button" class="nav-link border-0 btn btn-background-none" data-toggle="modal" data-target="#exampleModalCenter">
                            Add Post
                            </button>
                          </li>
